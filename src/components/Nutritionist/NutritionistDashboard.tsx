  ...
  const sendInvitation = async () => {
    ...
    try {
      ...
      const { data: userExists, error: userError } = await supabase
        ...
        .eq('username', newPatientUsername.trim().toLowerCase())
      ...
      if (userError) {
        ...
        toast({
          title: "Erro",
          description: "Erro ao verificar usuário: " + userError.message,
          variant: "destructive",
        });
        return;
      }
      ...
      if (!userExists) {
        toast({
          ...
          description: "Não existe um paciente com esse nome de usuário. Verifique se está correto.",
          variant: "destructive",
        });
        return;
      }
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          patient_username: newPatientUsername.trim().toLowerCase(),
